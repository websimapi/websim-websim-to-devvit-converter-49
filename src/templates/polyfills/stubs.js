        ...
        window.websim = {
            getCurrentUser: async () => {
                ...
                const u = getSharedUser() || {
                    id: 'guest', username: 'Guest', avatar_url: 'https://www.redditstatic.com/avatars/avatar_default_02_FF4500.png', avatarUrl: 'https://www.redditstatic.com/avatars/avatar_default_02_FF4500.png'
                };
                
                // Polyfill camelCase/snake_case consistency
                if (u.avatar_url && !u.avatarUrl) u.avatarUrl = u.avatar_url;
                if (u.avatarUrl && !u.avatar_url) u.avatar_url = u.avatarUrl;
